 ...
 * o profissional recuperar os dados da empresa ao trocar de celular. Mas se o
 * plano morasse la, ele viajaria junto:
 *
 ...
 *
 * Mesma decisao que o fiado ja tomou — ver `apps/fiado/src/licenca.ts`.
 */
 ...
 * orcamentos, criar orcamento, exportar, ajustes) e muda quase nunca.
 *
