 ...
 * Trava do app.
 *
 * Mesmo mecanismo do fiado e orcamento (`apps/fiado/src/trava.ts`) — ver os
 * comentarios la sobre o que um PIN de 4 digitos protege de fato e o que nao
 * protege.
 *
 * Chaves proprias declaradas aqui: bancos sao separados por app, entao nao ha
 * colisao possivel.
 */
