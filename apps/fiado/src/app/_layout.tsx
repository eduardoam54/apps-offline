...
import { ProvedorTema, temaFiado } from '@repo/ui';
...
export default function RootLayout() {
  ...
  const tema = esquemaDoSistema === 'dark' ? temaFiado.escuro : temaFiado.claro;
      ...
      <SafeAreaProvider>
        <View
          ...
          <Text style={{ fontSize: tema.fonte.titulo, fontWeight: tema.peso.destaque, color: tema.cores.texto }}>
            Não foi possível abrir a caderneta
          </Text>
