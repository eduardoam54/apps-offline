 ...
 * Tela de desbloqueio.
 *
 * E renderizada no lugar do app inteiro, e nao como uma rota: rota pode ser
 * contornada por deep link ou por historico de navegacao, e uma trava
 * contornavel nao e trava.
 *
 * O teclado e proprio em vez de TextInput para os alvos serem grandes e o PIN
 * nunca passar pelo teclado do sistema, que tem historico e sugestao.
 */
